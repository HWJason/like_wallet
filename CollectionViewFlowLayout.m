...
//                    self.currentCellShrinkMarginLeft = left;
                ...
                else if (indexPath.item == self.currentIndexPath.item+1){
                    NSLog(@"2");
                    cellRect = CGRectMake(0, offsetY + (kCollectionViewHeight - kExpandBottomHeight) + top, kCollectionViewWidth - inset.right, kCellHeight);
                }
                else {
                    NSLog(@"3");
                    cellRect = CGRectMake(0, offsetY + (kCollectionViewHeight - kExpandBottomHeight) + top, kCollectionViewWidth - inset.right, kCellHeight);
//                    shrinkCellIndex++;
                    att.alpha = 0;
//                    shrinkCellIndex = MIN(shrinkCellIndex, 0);
                }
            } else {
                att.alpha = 1;
